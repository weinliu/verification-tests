...
var _ = g.Describe("[sig-networking] SDN", func() {
	...
	g.It("NonHyperShiftHOST-Author:weliang-Medium-60507-Multihoming Verify multihoming pods dualstack connectivity", func() {
		...
		e2e.Logf("The v4 address of pod1 is: %v", pod2IPv4)
		e2e.Logf("The v6 address of pod1 is: %v", pod2IPv6)

		g.By("Get IPs from the pod3's secondary interface")
		pod3Name := getPodName(oc, ns1, "name=multihoming-pod3")
		pod3IPv4, pod3IPv6 := getPodMultiNetwork(oc, ns1, pod3Name[0])
		e2e.Logf("The v4 address of pod1 is: %v", pod3IPv4)
		e2e.Logf("The v6 address of pod1 is: %v", pod3IPv6)
