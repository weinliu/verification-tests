...
var _ = g.Describe("[sig-networking] SDN", func() {
	...
	g.It("Author:huirwang-HyperShiftGUEST-High-50347-internalTrafficPolicy set Local for pod/node to service access", func() {
		var (
	...
	// author: huirwang@redhat.com
	g.It("Author:huirwang-HyperShiftGUEST-High-50348-internalTrafficPolicy set Local for pod/node to service access with hostnetwork pod backend. [Serial]", func() {
		var (
			buildPruningBaseDir    = exutil.FixturePath("testdata", "networking")
