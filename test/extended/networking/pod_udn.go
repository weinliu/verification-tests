...
var _ = g.Describe("[sig-networking] SDN udn", func() {
	...
	g.It("Author:huirwang-Critical-75942-Validate pod2Service/nodePortService for UDN(Layer3)", func() {
		...
		exutil.By("6. create a nodePort service in ns1")
		...
		exutil.By("10. Not be able to access udn serive from default network.")
		CurlPod2SvcFail(oc, ns2, ns1, testPodName[0], svc.servicename)
		exutil.By("11. Not be able to access default network serive from udn network.")
