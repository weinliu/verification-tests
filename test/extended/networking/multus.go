...
var _ = g.Describe("[sig-networking] SDN", func() {
	...
	g.It("Author:weliang-HyperShiftGUEST-Medium-46387-[BZ 1896533] network operator degraded due to additionalNetwork in non-existent namespace. [Disruptive]", func() {
		var (
