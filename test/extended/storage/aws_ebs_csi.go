...
var _ = g.Describe("[sig-storage] STORAGE", func() {
	...
	for i := 0; i < len(caseIds); i++ {
		...
		// author: pewang@redhat.com
		g.It("HyperShiftGUEST-ROSA-OSD_CCS-Author:pewang-High-"+caseIds[i]+"-[AWS-EBS-CSI] [VOLUME-TYPES] dynamic "+volumeType+" type ebs volume should store data and allow exec of files", func() {
