...
var _ = g.Describe("[sig-network-edge] Network_Edge should", func() {
	...
	g.It("Author:shudili-Low-49131-check haproxy's version", func() {
		var expVersion = "haproxy26-2.6.13-2.rhaos4.15.el8"
		g.By("Try to get HAProxy's version in a default router pod")
	...
	g.It("ROSA-OSD_CCS-ARO-Author:shudili-High-66662-adding/deleting http headers to a reen route by a router owner", func() {
		...
		readHaproxyConfig(oc, routerpod, "be_secure:"+project1+":r2-reen", "-A33", "X-SSL-Client-Cert")
