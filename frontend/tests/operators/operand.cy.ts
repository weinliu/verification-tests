...
describe('operand tests', () => {
  ...
  it('(OCP-46583,xiyuzhao,UI) Operator should be able to customize order of conditions table', {tags: ['e2e','admin','@osd-ccs','@rosa']}, () => {
  ...
  it('(OCP-63078,yapei,UI)Enable filtering for k8sResourcePrefix x-descriptor', {tags: ['e2e','admin','@osd-ccs','@rosa']}, () => {
