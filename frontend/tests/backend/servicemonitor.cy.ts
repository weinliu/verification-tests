describe('servicemonitor', () => {
  it('(OCP-53843,xiyuzhao,UserInterface) Add client certificate and key path to servicemonitor of console and console-operator',{tags:['@userinterface','@e2e','admin','@rosa','@osd-ccs','@hypershift-hosted']}, () => {
