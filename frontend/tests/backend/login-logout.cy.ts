...
describe('login and logout', () => {
  it('(OCP-73149,yapei,UserInterface)do not reveal system info before login completion and should delete token after user logout', {tags: ['@userinterface','@e2e','@rosa','@osd-ccs','@wrs','V-BR.22','V-BR.48']}, () => {
