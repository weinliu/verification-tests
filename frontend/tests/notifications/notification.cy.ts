...
describe('Notification drawer tests', () => {
  ...
  it('(OCP-45305,yanpzhan,UI) check alert on overview page and notification drawer list', {tags: ['e2e','admin','@osd-ccs','@rosa']}, () => {
  ...
  it('(OCP-43119,yapei,UI) Check alerts are filtered based on Pod/Project/Node labels', {tags:['e2e', 'admin']}, () => {
