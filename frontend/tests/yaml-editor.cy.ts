...
describe("yaml editor tests", () => {
  ...
  it("(OCP-63312,yanpzhan,UI) Add ability to show/hide tooltips in the yaml editor", {tags: ['e2e','@osd-ccs','@rosa']}, () => {
  ...
  it("(OCP-21956,xiyuzhao,UI) drag and drop file for Import YAML page", {tags: ['e2e','@osd-ccs','@rosa']}, () => {
...
/*     cy.byTestID('retry-failed-resources').click({force:true}).then(() => {
  ...
  it("(OCP-68746,xiyuzhao,UI) Yaml editor can handle a line of data longer than 78 characters", {tags: ['e2e','@osd-ccs','@rosa']}, () => {
