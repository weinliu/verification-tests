...
describe('logs related features', () => {
  ...
  it('(OCP-68420,yanpzhan,UserInterface) Should maintain white-space in pod log on console', {tags: ['e2e','@osd-ccs','@rosa']}, () => {
  ...
  it('(OCP-54875,yanpzhan,UserInterface) Configure default behavior for "Wrap lines" in log viewers by pod annotation', {tags: ['e2e','@osd-ccs','@rosa']}, () => {
