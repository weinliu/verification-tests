...
describe('logs related features', () => {
  ...
  it('(OCP-69245,yanpzhan,UI) Add option to enable/disable tailing to Pod log viewer', {tags: ['e2e','admin','@osd-ccs','@rosa']}, () => {
  ...
  it('(OCP-68420,yanpzhan,UI) Should maintain white-space in pod log on console', {tags: ['e2e','@osd-ccs','@rosa']}, () => {
  ...
  it('(OCP-54875,yanpzhan,UI) Configure default behavior for "Wrap lines" in log viewers by pod annotation', {tags: ['e2e','@osd-ccs','@rosa']}, () => {
