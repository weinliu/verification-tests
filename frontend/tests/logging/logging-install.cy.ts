...
describe('Logging related features', () => {
  ...
  it('(OCP-22558,gkarager,Logging) Deploy cluster-logging operator via web console', {tags: ['e2e','admin']}, () => {
  ...
  it('(OCP-24292,gkarager,Logging) Deploy elasticsearch-operator via Web Console', {tags: ['e2e','admin']}, () => {
  ...
  it('(OCP-70833,gkarager,Logging) Deploy loki-operator via Web Console', {tags: ['e2e','admin']}, () => {
