...
describe("namespace dropdown favorite test", () => {
  ...
  it("(OCP-45319,xiyuzhao,UI) - Check the system namespaces that are Favorited will list in the Favorited list even if 'show default projects' is unselectedt", {tags: ['e2e','admin']}, () => {
    const namespaces = [
