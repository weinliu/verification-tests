...
describe('command line tools page', () => {
  ...
  it('(OCP-64621,yanpzhan,UserInterface)cutomized "downloads" route should be updated and honored in CLI download links',{tags:['@userinterface','@e2e','admin','@hypershift-hosted']}, () => {
