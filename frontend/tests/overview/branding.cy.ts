...
describe("Branding check", () => {
  it("(OCP-48357,yanpzhan,UserInterface) Switch the OCP branding logo and title to Red Hat OpenShift logo and title",{tags:['@userinterface','@e2e','@smoke','@hypershift-hosted']}, () => {
    cy.visit('/');
