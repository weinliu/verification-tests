...
describe('Check on hypershift provisined cluster', () => {
  ...
  it('(OCP-50740,yanpzhan,UserInterface) Remove manchine related resources for HyperShift Provisioned Clusters',{tags:['@userinterface','HyperShiftGUEST','admin']}, () => {
    sideNav.checkNoMachineResources();
    searchPage.checkNoMachineResources();
    crds.checkNoMachineResources();
  });

  it('(OCP-51733,yanpzhan,UserInterface) Check no idp alert for temporary administrative user on HyperShift Provisioned Clusters',{tags:['@userinterface','HyperShiftGUEST','admin']}, () => {
