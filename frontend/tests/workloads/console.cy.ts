...
describe("console related deployments test", () => {
  it("(OCP-69183,yanpzhan,UI) Set readOnlyRootFilesystem field for both console and console operator related containers", {tags: ['e2e','admin','@osd-ccs','@rosa']}, () => {
    // check console operator deployment
    Deployment.checkDeploymentFilesystem('console-operator','openshift-console-operator',0,true);
    Deployment.checkDeploymentFilesystem('console-operator','openshift-console-operator',1,true);
